          ...
          <div className="p-2 bg-[#F3F4FD] drop-shadow-lg m-8">
            <div className="space-y-12">
              ...
              <ul className="space-y-2 list-disc list-outside pl-4 mx-12 lg:mx-24">
                ...
                <li>
                  Q3: Where can I find Rush 22W and purchase it for my charging needs?
                  Rush 22W is delivered after you book from our website. Use the link to order now.
                ...
                <li>Q5: Can it charge my Bluetooth speaker?
                  Absolutely! Rush 22W is compatible with Everything that uses USB charging. Whether you need it for your smartphone, tablet, smartwatch, or other gadgets
                </li>
                <li>Q6: What is the significance of power switching in Rush 22W?
                  It helps in efficiency. Rush 22W uses fast-switch synchronous rectifiers to manage power switching effectively. This optimizes the transfer of power, reducing energy wastage t. It contributes to faster charging times and lower energy consumption.
                </li>
