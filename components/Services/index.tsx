	...
	return (
		<>
			<div className="mx-24">
				...
				<h3 className=" mb-8 font-Inter font-large text-sm md:text-md lg:text-lg md:mb-8   tracking-wide  text-start text-[#A6A6A6] pt-2" data-aos="fade-up">Collaboration is the key for a growing business and we offer different services like OBM, ODM and OEM to our clients.</h3>
