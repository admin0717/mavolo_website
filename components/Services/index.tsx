...
const Services: FC = () => {
	return (
		<>
			<div className="mx-24">
				<h1 className=" mt-8 font-Inter font-bold text-3xl  md:mt-8 capitalize leading-10 tracking-wide border-blurBG text-start " data-aos="fade-up">Our <span className="text-buttonBG">Services</span> </h1>
				<h3 className=" mb-8 font-Inter font-large text-sm md:text-md lg:text-lg md:mb-8   tracking-wide  text-start text-[#A6A6A6] border-b-2 pb-2 border-buttonBG" data-aos="fade-up">Collaboration is the key for a growing business and we offer different services like OBM, ODM and OEM to our clients.</h3>
