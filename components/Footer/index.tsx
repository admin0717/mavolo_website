    ...
    <>
      <footer
        ...
        <div className="w-full flex flex-col justify-between items-start lg:flex-row space-y-12 text-[#fff]">
          ...
          <div className="lg:w-1/3 flex items-start justify-center space-x-12 mr-10">
            ...
            <div className="lg:w-1/2 flex flex-col items-end justify-center">
              <Link href="/">
                <a className="text-lg font-Inter">About us</a>
              </Link>
              <Link href="/">
                <a className="text-lg font-Inter">Products</a>
              </Link>
              <Link href="/">
                <a className="text-lg font-Inter">Blogs</a>
              </Link>
              <Link href="#inquire">
                <a className="text-lg font-Inter">Write to us</a>
              </Link>
            </div>
          </div>
        </div>
