...
const Navbar: FC = () => {
  ...
  const Links = ["/products", "/blogs", "/about-us", "/contact-us"];
  return (
    <>
      ...
      {/* Mobile Screens */}
      <nav
        className={`flex md:hidden w-full px-20 md:px-24 sticky top-0 z-50 bg-[#fff] drop-shadow-sm   ${
          !isToggle ? "flex-col h-screen mx-0 px-24  scrollbar-hide" : ""
        }`}>
