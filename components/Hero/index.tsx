    ...
    <>
      <header className="lg:mx-24 mx-12 flex flex-col justify-center lg:items-start items-center space-y-20 lg:space-y-0 lg:space-x-20 mt-20 mb-24 lg:flex-row relative">
        <div className="flex flex-col justify-center items-start space-y-8 md:space-y-12 lg:space-y-8 lg:w-1/2">
          <div className="font-Inter font-bold lg:text-5xl md:text-6xl text-5xl tracking-wide lg:leading-tight leading-relaxed  text-center lg:text-start mx-auto px-auto lg:mx-0 lg:px-0">
            <div>
          ...
          <div className="flex justify-center lg:items-start items-center px-auto mx-auto space-x-8 lg:mx-0 lg:px-0">
            <Link href="/">
              <a className="font-Inter font-normal text-2xl md:text-lg   cursor-pointer p-2 rounded-md hover:border-2 hover:bg-primaryBG drop-shadow-md hover:text-buttonBG bg-buttonBG text-buttonText px-4">
                Explore
              </a>
            </Link>
            <Link href="#inquire">
              <a className="font-Inter font-normal text-2xl  lg:text-lg   cursor-pointer p-2 rounded-md hover:border-2 hover:bg-primaryBG drop-shadow-md hover:text-buttonBG bg-buttonBG text-buttonText px-4">
                Inquire
              </a>
            </Link>
          </div>
        </div>
        <div className="lg:w-1/2 mx-auto ml-32 md:ml-32 lg:ml-0">
